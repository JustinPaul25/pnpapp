            ...
            <section class="flex flex-col break-words bg-white sm:border-1 sm:rounded-md sm:shadow-sm">
                ...
                <form class="w-full px-6 space-y-6 sm:px-10 sm:space-y-8" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="flex items-center">
                        ...
                        <a class="text-sm font-bold text-gray-800 hover:text-gray-700 whitespace-no-wrap no-underline hover:underline ml-auto"
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <p class="w-full text-xs text-center text-gray-700 my-6 sm:text-sm sm:my-8">
                            ...
                            <a class="text-blue-500 hover:text-blue-700 no-underline hover:underline" href="{{ route('register-user') }}">
                                {{ __('Register') }}
                            </a>
                        </p>
                        @endif
